...
document.getElementById("Patvirtinti").addEventListener("click", function() { // paimtas elemetnas patvirtinti fiksuojamas jo paspaudimas, paspaudimo metu sukuriami kintamieji sk1 sk2

    let sk1, sk2;
    sk1 = parseFloat(document.getElementById("sk1").value); // priskiriamos reiksmes
    sk2 = parseFloat(document.getElementById("sk2").value);

// objektas pasiima reiksmes is getElementById laukelio
// Pirmas metodas perduoti kintamaji
//     const skaiciuotuvas = {
//         sk1: sk1,
//         sk2: sk2,
//         sudetis: function() {
...
//         rezultatas: function() {
//             console.log(skaiciuotuvas.sudetis());
//             console.log(skaiciuotuvas.atimtis());
//             console.log(skaiciuotuvas.daugyba());
//             console.log(skaiciuotuvas.dalyba());
//             // return
//         }
//     }
...
//antras metodas perduoti kintamaji 
const skaiciuotuvas = {
    sk1: 10,
    sk2: 11,
